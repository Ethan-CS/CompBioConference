...
We discussed:
  ...
  \begin{itemize}
  \item \uncover<2->{Existing approaches to computational models of disease spread}
  \item \uncover<3->{How to extend existing approaches to better account for agency}
  \item \uncover<4->{How using a compartmental framework can help introduce agency formally}
  \item \uncover<5->{Feasibility of describing compartmental graph models exactly}
  \end{itemize}
